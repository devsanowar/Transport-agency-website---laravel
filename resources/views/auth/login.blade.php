...
<head>
    ...
    <title> Login । {{ $website_setting->website_title }}</title>
</head>
                            ...
                            <div class="card-body p-sm-5">
                                <div class="">
                                    <div class="mb-3 text-center">
                                        ...
                                        <img src="{{ asset($website_setting->website_header_logo) }}" width="200" alt="">
                                        @else
                                        <img src="{{ asset('backend') }}/assets/images/logo-icon.png" width="60" alt="">
                                        @endif
                                    </div>
                                    <div class="text-center mb-4">
                                        <h5 class="">{{ $website_setting->website_title ?? '-' }} | এডমিন লগিন</h5>
