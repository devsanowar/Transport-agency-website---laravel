        ...
        <div class="main-body">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            {{-- <div id="profileCard" class="d-flex flex-column align-items-center text-center">
                                <img src="{{ asset('backend/assets/images/avatars/avatar-2.png') }}" alt="Admin"
                                    class="rounded-circle p-1 bg-primary" width="110">
                                <div class="mt-3">
                                    <h4 id="profileName">{{ $user->name ?? '' }}</h4>
                                    <p class="text-secondary mb-1" id="profileDesignation">{{ $user->designation ?? ''
                                        }}</p>
                                    <p class="text-muted font-size-sm" id="profileAddress">{{ $user->address ?? '' }}
                                    </p>
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <form id="userProfileForm" action="{{ route('admin.profile.update') }}" method="POST">
                                @csrf
                                @method('PUT')
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response.data){
                    ...
                    $('#profileDesignation').text(response.data.designation || '');
