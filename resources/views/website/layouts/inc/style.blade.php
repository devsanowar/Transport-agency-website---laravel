...
<link rel="stylesheet" href="{{ asset('frontend') }}/assets/css/module-css/cta.css" />
<link rel="stylesheet" href="{{ asset('frontend') }}/assets/css/module-css/find-transport.css" />
...
<style>
    :root {
        ...
        --tanspot-gray: {{ $website_color->gray }};
        --tanspot-gray-rgb: 88, 91, 107;
        --tanspot-base: {{ $website_color->base }};
        /* --tanspot-base: #FD5523; */
        --tanspot-base-rgb: 253, 85, 35;
        --tanspot-primary: {{ $website_color->primary }};
        --tanspot-primary-rgb: 244, 245, 249;
        --tanspot-black: {{ $website_color->black }};
        /* --tanspot-black: #062f3a; */
        --tanspot-black-rgb: 6, 47, 58;
        --tanspot-white: {{ $website_color->white }};
        --tanspot-white-rgb: 255, 255, 255;
        --tanspot-bdr-color: {{ $website_color->border_color }};
